...
`IOS_BUILD_NUMBER`, and both public TestFlight manifest URLs in
...
3. Run `pnpm testflight:verify-remotes` from a clean network and verify both cards sets after restart.
